...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        'nom', 'prenoms', 'telephone', 'email', 'type', 'password',
        'avatar', 'adresses_favoris', 'disponible', 'latitude', 'longitude', 'actif'
    ];
    ...
    {
        // Un utilisateur de type 'agence' a une et une seule agence associée.
